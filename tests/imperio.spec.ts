...
import { MetricLengthAdapter } from '../src/imperio/metriclengthadapter.ts';
import { ImperialLength } from '../src/imperio/imperiallength.ts';
import { MetricLength } from '../src/imperio/metriclength.ts';
